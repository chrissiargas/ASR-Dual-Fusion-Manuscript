...
Crucially, this coarser downsampling factor ($k=5$, 100ms resolution) prevents quadratic computational bloat in the LLM's global self-attention sequence, while alinging with syllabic boundaries.
